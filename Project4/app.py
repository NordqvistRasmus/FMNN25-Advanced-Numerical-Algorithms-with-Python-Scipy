...
@app.route('/nysidatest')
def exampletva():


	mydata = [{'name': 'apple'}, {'name': 'mango'}, {'name': 'banana'}]
	return render_template('nysidatest.html', items=mydata)
...
#	if len(response_deals) > 0:
#		return render_template('nysidatest.html', deals=response_deals)
#	else:
#		msg = 'No deals found'
#		return render_template('nysidatest.html', msg=msg)
